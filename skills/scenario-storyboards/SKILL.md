...
| Stage             | Do                                                                                                                                          |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Script         | A beat table before any generation: per panel, the framing, the action, the setting, the dialogue                                           |
...
A storyboard headed for animation stops at stage 4: approved panels become first frames for image-to-video (`scenario-video`), one clip per shot.
