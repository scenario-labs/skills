...
5. Verify access from a scope outside the owning team, including download and reference use. Only then add the public asset IDs, role, version, and source file hash to the template guide. Never put signed download URLs or destination IDs there.
