...
asset id as the next shot's `image` instead of the drawn still, and rewrite that shot's STARTING STATE
and its TIMELINE beat's entry pose to what the frame shows rather than what the script planned.
