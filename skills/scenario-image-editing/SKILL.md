...
Both reframes recompose generatively rather than filling canvas, and they are the chain's expensive step, tens of times an effect's price: `dry_run` them. They re-render, so reframe first and grade after: a grade or grain pass applied beforehand comes back partly reinterpreted.
