...
{
    [CreateAssetMenu(menuName = "Game/Events/Void Channel", fileName = "EVT_")]
    public sealed class VoidEventChannel : EventChannel<Unit>
    {
        public void Raise() => Raise(default(Unit));
    }
}
